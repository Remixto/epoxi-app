...
import io.epoxi.app.repository.api.model.DevelopersApi;
import io.epoxi.app.repository.api.model.ControllerBase;
...
public class DevelopersApiController extends ControllerBase implements DevelopersApi {
    ...
    public void undeleteIngestion(Long id) {
        throw new UnsupportedOperationException("Undeletes are not yet implemented by the API");  //TODO fix this
    }
